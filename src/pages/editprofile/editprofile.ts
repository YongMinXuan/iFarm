...
export class EditprofilePage {
  ...
  change(){
    ...
    if (this.image) {
      ...
      let ref = firebase.storage().ref("ProfileImages/" + firebase.auth().currentUser.uid);// need to add in a default image for people that dont add profile image.
      ...
      uploadTask.on("state_changed", (taskSnapshot: any) => {
        ...
        uploadTask.snapshot.ref.getDownloadURL().then((url) => {
          ...
          let newUser: firebase.User =firebase.auth().currentUser;
